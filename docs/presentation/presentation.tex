...
\subsection{ASP Core}
	...
	\begin{frame}[fragile]
		\frametitle{ASP Example: the 8 queens problem}
			\only{\includegraphics[width=\linewidth]{imagenes/queens/eightqueens_facts.png}}<1 | handout:0>
			\only{\includegraphics[width=\linewidth]{imagenes/queens/eightqueens_aux.png}}<2| handout:0>
			\only{\includegraphics[width=\linewidth]{imagenes/queens/eightqueens_wrongsol.png}}<3 | handout:0>
			\only{\includegraphics[width=\linewidth]{imagenes/queens/eightqueens_rightgsol.png}}<4>
	\end{frame}
