...
\begin{itemize}
	...
	\item \textbf{ANTON} es un sistema de composición rítmica, melódica y armónica basado en Answer Set Programming. ANTON compone breves piezas musicales desde cero o partiendo de partituras incompletas utilizando un estilo basado en el del compositor renacentista Giovanni Pierluigi da Palestrina. Recibe como entrada ficheros con las notas codificadas como hechos lógicos para después rellenar las secciones incompletas o añadir nuevas notas hasta que la pieza está completa. ANTON crea y completa dichas piezas teniendo en cuenta el número de tiempos rítmicos de las mismas y seleccionando la nota correspondiente de acuerdo a la nota  o estado anterior
	\item \textbf{Vox Populi} utiliza algoritmos evolutivos para componer música en tiempo real. En este sistema, se parte de una población de acordes codificados mediante el protocolo MIDI para después mutarlos y seleccionar los mejores acordes a criterios puramente físicos relevantes para la música. Su interfaz gráfica permite al usuario controlar la función de \textit{fitness} del proceso evolutivo así como los atributos del sonido producido.
...
Existen también las conocidas como figuras irregulares que sirven para comprimir o expandir la duración de un conjunto de figuras a una cantidad de tiempo determinada, algunos ejemplos son el tresillo y el dosillo. El tresillo es un conjunto de tres subdivisiones de la figura principal del compás, por ejemplo, tres corcheas consecutivas que ocupan el tiempo de una negra, cada una durando un tercio de ese tiempo en vez de la mitad, que sería su duración habitual. El dosillo en cambio se usa en compases ternarios (véase la explicación de los tipos de compases más adelante) donde dos figuras ocupan el lugar de tres, por ejemplo, dos corcheas ocupan el lugar de una negra con puntillo, repartiendose ese tiempo y medio de la corchea entre las dos corcheas del dosillo equitativamente.
...
\begin{figure}
	\centering
	\includegraphics[width=0.4\linewidth]{imagenes/triplets.png}
	\includegraphics[width=0.46\linewidth]{imagenes/duplets.png}
	\caption{Equivalencias de tiempos entre tresillos y dosillos}
	\label{fig:tresillo_dosillo}
\end{figure}
